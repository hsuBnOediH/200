...
#### [P147](https://github.com/hsuBnOediH/200/blob/master/Passage%20147)
 ...
 #### [P157](https://github.com/hsuBnOediH/200/blob/master/Passage%20157)
 
 ```aidl
The apparent degree of relatedness of some species, as determined by anatomical criteria, 
is not borne out by their degree of genetic similarity
brone out 证实

如果是一点都不能证实的话 为什么新方法会改变view
第一句就一定表达了 一种替代的感觉
```


 #### [P162](https://github.com/hsuBnOediH/200/blob/master/Passage%20162)
 ```aidl
In the Rocky Mountains, the current timberline is at the altitude above which growing 
season temperatures remain cooler than 10 degrees centigrade.
在落基山脉, 现在的t是海拔以上, 这个海拔是生长季节的温度在10度以下的海拔

在timberline 一定是耐寒的 不用说啊
落基山脉过加拿大的
现在的time不是耐寒的吗?
不耐寒怎么长最高的? 低于10度了 还不耐寒?
```


 #### [P163](https://github.com/hsuBnOediH/200/blob/master/Passage%20163)
 ```aidl
 first graders?
 first grader?
 grader?
